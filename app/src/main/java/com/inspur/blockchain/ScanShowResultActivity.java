...
public class ScanShowResultActivity extends BaseActivity {
    ...
    protected void initData() {
        ScanResultShowViewModel scanResultShowViewModel = new ViewModelProvider(this).get(ScanResultShowViewModel.class);
        showProgressLoading();
        scanResultShowViewModel.requestData(getIntent().getStringExtra(Keys.QR_CODE_RESULT)).observe(this, new Observer<JSONObject>() {
            @Override
